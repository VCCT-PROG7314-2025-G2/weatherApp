...
class WeatherViewModel(application: Application) : AndroidViewModel(application) {
     ...
     * 
     * Attempts to load weather data from the repository's current location.
     * If no current location is set, defaults to Johannesburg, South Africa.
     * Updates LiveData observables for UI components to react to changes.
     */
    fun loadWeatherData() {
     ...
     * 
     * Fetches current weather, hourly forecast, and daily forecast for the given location.
     * Updates all LiveData observables and handles errors gracefully.
     * 
     * @param locationId The location identifier (city name or coordinates)
     */
     ...
     * 
     * Searches for weather data by city name. This method is used when users
     * search for a new location. Handles API errors and provides user-friendly
     * error messages for common scenarios (404, 401, network errors).
     * 
