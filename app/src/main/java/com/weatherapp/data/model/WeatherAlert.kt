...
data class WeatherAlert(
    ...
    fun getSeverityIcon(): Int {
        return when (severity) {
            AlertSeverity.MINOR -> com.weatherapp.R.drawable.ic_alert_minor
            AlertSeverity.MODERATE -> com.weatherapp.R.drawable.ic_alert_moderate
            AlertSeverity.SEVERE -> com.weatherapp.R.drawable.ic_alert_severe
            AlertSeverity.EXTREME -> com.weatherapp.R.drawable.ic_alert_extreme
        }
    }
}
