...
class AuthManager(private val context: Context) {
     ...
     * 
     * Reads the login state from SharedPreferences. This does not validate
     * session expiration - use isSessionValid() for that.
     * 
     * @return true if user is marked as logged in, false otherwise
     */
     ...
     * 
     * Validates that the user's session has not expired. Sessions are valid
     * for 24 hours from the login timestamp. This prevents unauthorized access
     * after extended periods of inactivity.
     * 
     * @return true if session is valid (logged in and not expired), false otherwise
     */
