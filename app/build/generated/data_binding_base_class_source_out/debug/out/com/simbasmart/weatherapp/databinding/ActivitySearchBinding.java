...
public final class ActivitySearchBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvPopularCities;

  private ActivitySearchBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnSearch,
      @NonNull AutoCompleteTextView etSearch, @NonNull ProgressBar progressBar,
      @NonNull TextView tvError, @NonNull TextView tvPopularCities) {
    this.rootView = rootView;
    this.btnSearch = btnSearch;
    this.etSearch = etSearch;
    this.progressBar = progressBar;
    this.tvError = tvError;
    this.tvPopularCities = tvPopularCities;
  }
  ...
  public static ActivitySearchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_popular_cities;
      TextView tvPopularCities = ViewBindings.findChildViewById(rootView, id);
      if (tvPopularCities == null) {
        break missingId;
      }

      return new ActivitySearchBinding((LinearLayout) rootView, btnSearch, etSearch, progressBar,
          tvError, tvPopularCities);
    }
